        ...
        Nav::widget(
            [
                ...
                'items' => [
                    ...
                    ['label' => '<i class="fa fa-users"></i><span>confirmarusuario</span>', 'url' => ['../web/site/confirmarusuario']],
                    ...
                    ['label' => '<i class="fa fa-users"></i><span>Rutas</span>', 'url' => ['../web/rutas/index']],
                    ['label' => '<i class="fa fa-users"></i><span>Pedidos</span>', 'url' => ['../web/pedidos/index']],
                    ['label' => '<i class="fa fa-users"></i><span>Stock</span>', 'url' => ['../web/stock/index']],
